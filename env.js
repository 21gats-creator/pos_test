...
window.ENV = {
    ...
    // ══════════════════════════════════════════════
    // รันบน XAMPP (http://localhost/pos_Gemini/) → ไม่ต้องแก้ ปล่อยว่างไว้
    // รันบน GitHub Pages / hosting อื่น → ใส่ URL ของ XAMPP เช่น:
    //   'http://192.168.1.100/pos_Gemini'   ← IP เครื่องที่รัน XAMPP บน LAN
    // ข้อจำกัด: หากหน้าเว็บเป็น HTTPS แต่ XAMPP เป็น HTTP จะ block (Mixed Content)
    PROMPTPAY_API_BASE: '',
